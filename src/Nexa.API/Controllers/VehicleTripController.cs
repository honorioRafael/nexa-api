...
public class VehicleTripController : BaseController<VehicleTrip, IVehicleTripService, CreateVehicleTripDto, UpdateVehicleTripDto>
{
    ...
    #region Create
    [HttpPost("Create")]
    public override async Task<IActionResult> Create(CreateVehicleTripDto dto)
    {
        try
        {
    ...
    public override async Task<IActionResult> CreateMultiple(List<CreateVehicleTripDto> dtos)
    {
        try
        {
    ...
    #region Update
    [HttpPut("Update/{id}")]
    public override async Task<IActionResult> Update(long id, UpdateVehicleTripDto dto)
    {
        try
        {
    ...
    public override async Task<IActionResult> UpdateMultiple(Dictionary<long, UpdateVehicleTripDto> idDtoPairs)
    {
        try
        {
