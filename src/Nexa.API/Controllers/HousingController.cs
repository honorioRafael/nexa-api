...
public class HousingController : BaseController<Housing, IHousingService, HousingDto, CreateHousingDto, UpdateHousingDto>
{
    ...
    protected override HousingDto MapToDto(Housing entity) =>
        new(entity.Id, entity.Name, entity.Address, entity.City, entity.ZipCode, entity.MaxCapacity, entity.CurrentCapacity, entity.Status);
}
