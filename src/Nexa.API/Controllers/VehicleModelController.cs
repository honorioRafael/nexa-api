...
public class VehicleModelController : BaseController<VehicleModel, IVehicleModelService, CreateVehicleModelDto, UpdateVehicleModelDto>
{
    ...
    #region Create
    [HttpPost("Create")]
    public override async Task<IActionResult> Create(CreateVehicleModelDto dto)
    {
        try
        {
    ...
    public override async Task<IActionResult> CreateMultiple(List<CreateVehicleModelDto> dtos)
    {
        try
        {
    ...
    #region Update
    [HttpPut("Update/{id}")]
    public override async Task<IActionResult> Update(long id, UpdateVehicleModelDto dto)
    {
        try
        {
    ...
    public override async Task<IActionResult> UpdateMultiple(Dictionary<long, UpdateVehicleModelDto> idDtoPairs)
    {
        try
        {
