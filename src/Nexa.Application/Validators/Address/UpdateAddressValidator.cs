...
public class UpdateAddressValidator : AbstractValidator<UpdateAddressDto>
{
    public UpdateAddressValidator()
    {
        ...
        RuleFor(x => x.Number)
            ...
            .MaximumLength(10).WithMessage("O Número é deve ter no máximo 10 caracters.");
        ...
        RuleFor(x => x.Neighborhood)
            ...
            .MaximumLength(50).WithMessage("O Bairro é deve ter no máximo 50 caracters.");

        RuleFor(x => x.City)
            .NotEmpty().WithMessage("A Cidade é obrigatória.")
            .MaximumLength(40).WithMessage("A Cidade é deve ter no máximo 40 caracters.");

        RuleFor(x => x.State)
            .NotEmpty().WithMessage("O Estado é obrigatório.")
            .MaximumLength(40).WithMessage("O Estado é deve ter no máximo 40 caracters.");

        RuleFor(x => x.Country)
            .NotEmpty().WithMessage("O País é obrigatório.")
            .MaximumLength(40).WithMessage("O País é deve ter no máximo 40 caracters.");

        RuleFor(x => x.ZipCode)
            .NotEmpty().WithMessage("O Códgio Postal (CEP) é obrigatório.")
            .MaximumLength(15).WithMessage("O Códgio Postal (CEP) é deve ter no máximo 15 caracters.");
    }
}
